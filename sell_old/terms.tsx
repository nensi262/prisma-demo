...
export default function Describe() {
  ...
  const acceptTerms = trpc.listings.acceptTerms.useMutation();

  return (
    <>
      <FlowSection>
        <H1>The boring legal bits</H1>
      ...
      <FlowSection>
        <div className="max-h-[500px] border-2 bg-gray-50 p-4 rounded-md overflow-scroll mt-10">
          ...
          <section className="mb-8">
            ...
            <p>
              Welcome to Moove, the peer-to-peer property selling marketplace.
              By accessing or using our platform, you agree to comply with and
              be bound by these Terms and Conditions. Please read these terms
              carefully before using Moove. If you do not agree with these
          ...
          <section className="mb-8">
            ...
            <ul>
              ...
              <li>
                <strong>&quot;Buyer&quot;</strong> refers to a user interested
                in purchasing a property.
              </li>
              <li>
                <strong>&quot;Seller&quot;</strong> refers to a user interested
                in selling a property.
              </li>
              <li>
                <strong>&quot;Transaction&quot;</strong> refers to the process
                of buying or selling a property through Moove.
              </li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              accurately represent the property, and users are responsible for
              the content and accuracy of their listings.
            </p>
            <p>
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              property transactions. Moove is not responsible for any disputes
              or issues that may arise during a transaction.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              Moove may modify these Terms and Conditions at any time. Users
              will be notified of changes, and continued use of our platform
