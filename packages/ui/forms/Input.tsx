    ...
    <div className={className}>
      ...
      <div className="relative">
        ...
        <input
          ...
          id={id}
          onChange={onChange}
          className={`${inputClassName} block w-full py-2.5 px-3 text-gray-900 bg-gray-50 border border-gray-200 placeholder:text-gray-400 focus:ring-2 focus:outline-none ${
